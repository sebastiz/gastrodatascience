...
## The prepared EndoHist merge script

This is the script used to prepare the data used in many of the examples here. I have listed it as is. 
```{r PreparedData_All}
library(dplyr)
library(stringr)
library(fuzzyjoin)
...
Endodat<-sample(seq(as.Date('2013/01/01'), as.Date('2017/05/01'), by="day"), 1000)
EndoHospNum<-sample(c("P433224","P633443","K522332","G244224","S553322","D0739033","U873352","P223333","Y763634","I927282","P223311","P029834","U22415","U234252","S141141","O349253","T622722","J322909","F630230","T432452"), 1000, replace = TRUE)
...
list.of.samples <- replicate(1000, paste("Macrosopic description:",sample(1:10,1), "specimens collected the largest measuring", sample(1:5,1) ,"x", sample(1:5,1) ,"x", sample(1:5,1), "mm and the smallest", sample(1:5,1) ,"x", sample(1:5,1) ,"x", sample(1:5,1), "mm"), simplify=FALSE)

library('stringr')
#Merge the strings together randomly
histop<-replicate(1000,paste (sample(list.of.samples,1,replace=F),paste("Diagnoses",str_c(sample(line,sample(3:10,1),replace=F),collapse='.'))))   
...
dat<-sample(seq(as.Date('2013/01/01'), as.Date('2017/05/01'), by="day"), 1000)
