...
There are many ggplots and some good repositories to look at [are here ](http://www.statmethods.net/advgraphs/ggplot2.html) (http://sape.inf.usi.ch/quick-reference/ggplot2) and [50 top visualisations] (http://r-statistics.co/Top50-Ggplot2-Visualizations-MasterList-R-Code.html) and [All R graphs] (https://www.r-graph-gallery.com/)
